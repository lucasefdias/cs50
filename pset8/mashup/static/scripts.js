...
function addMarker(place)
{
    ...
    google.maps.event.addListener(marker, 'click', function() {
        ...
        $.getJSON("/articles", parameters, function(data, textStatus, jqXHR) {
            ...
            // Loop through the first 5 articles and append each article to content string
            for (let i = 0; i < 5; i++)
            {
            ...
            // Show info window with articles
...
{
    // Iterater over all markers in marker array and remove them from map
